...
package com.GoKart.controller.datastructure;
...
public class CustomQUEUE {
    ...
    private LinkedList<model1> vivaList; // Internal storage for the queue.
     ...
     * queue is full.
     */
    public int enQueue(model1 studentModel) {
        if (isFull()) {
