...
public class InsertionSort {
    ...
    /**
     * Sorts a list of GoKartModel objects by their Full Name in ascending or
 descending order using the Insertion Sort algorithm.
     ...
     */
    public List<GoKartModel> sortByFullName(List<GoKartModel> racerList, boolean isDesc) {
        ...
        for (int i = 1; i < racerList.size(); i++) {
            GoKartModel key = racerList.get(i);  // The element to be inserted
            int j = i - 1;
