...
public class BinarySearch {
    ...
    /**
     * Searches for a racer by their full name using binary search and updates
     * the table.
     *
     * @param searchValue the full name to search for
     * @param racerList the sorted list of GoKartModel objects
     ...
     */
    public void searchAndUpdateTable(String searchValue, List<GoKartModel> racerList, int left, int right, JTable table) {
        GoKartModel foundRacer = searchByFullName(searchValue, racerList, left, right);
     ...
     * @param left the starting index of the search range
     * @param right the ending index of the search range
     * @return the GoKartModel object if found; otherwise, null
     */
    private GoKartModel searchByFullName(String searchValue, List<GoKartModel> racerList, int left, int right) {
