...
public class SelectionSort {
    ...
    List<GoKartModel> RacerSortList;
    ...
    /**
     * Sorts a list of GoKartModel objects by their Kart Number in ascending or
 descending order.
     *
     * @param racerList the list of GoKartModel objects to be sorted
     * @param isDesc specifies the sort order (true for descending, false for
     * ascending)
     * @return the sorted list
     */
    public List<GoKartModel> sortByKartNumber(List<GoKartModel> racerList, boolean isDesc) {
     ...
     *
     * @param racerSortList the list of GoKartModel objects
     * @param startIndex the index to start searching from
     * @param isDesc specifies whether to find the maximum (true) or minimum
     * (false)
     * @return the index of the extremum value
     */
    private int findExtremumIndex(List<GoKartModel> racerSortList, int startIndex, boolean isDesc) {
     ...
     */
    private void swap(List<GoKartModel> racerSortList, int i, int j) {
        GoKartModel temp = racerSortList.get(i);
